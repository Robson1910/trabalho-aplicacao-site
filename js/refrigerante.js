const dbRefObject = firebase.database().ref().child('Bebidas'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Bebidas'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Bebidas'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Bebidas'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Bebidas'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Bebidas'); 
