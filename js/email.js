const dbRefObject = firebase.database().ref().child('emailCadastro');
dbRefObject.on('child_added', snap => {
 ...
 const dbRefObject1 = firebase.database().ref().child('emailCadastro');
dbRefObject1.on('child_added', snap => {
 ...
 const dbRefObject2 = firebase.database().ref().child('emailCadastro');
