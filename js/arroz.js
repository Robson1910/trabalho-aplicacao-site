const dbRefObject = firebase.database().ref().child('Arroz'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Arroz'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Arroz'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Arroz'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Arroz'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Arroz'); 
