const dbRefObject = firebase.database().ref().child('Feijão'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Feijão'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Feijão'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Feijão'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Feijão'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Feijão'); 
