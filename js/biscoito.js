const dbRefObject = firebase.database().ref().child('Biscoito'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Biscoito'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Biscoito'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Biscoito'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Biscoito'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Biscoito'); 
