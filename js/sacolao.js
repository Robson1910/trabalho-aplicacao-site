const dbRefObject = firebase.database().ref().child('Sacolão'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Sacolão'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Sacolão'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Sacolão'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Sacolão'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Sacolão'); 
