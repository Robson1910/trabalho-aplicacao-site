const dbRefObject = firebase.database().ref().child('Carne'); 
 ...
 //
 const dbRefObject1 = firebase.database().ref().child('Carne'); 
 ...
 //
 const dbRefObject2 = firebase.database().ref().child('Carne'); 
 ...
 //
 const dbRefObject3 = firebase.database().ref().child('Carne'); 
 ...
 //
 const dbRefObject4 = firebase.database().ref().child('Carne'); 
 ...
 //
 const dbRefObject5 = firebase.database().ref().child('Carne'); 
